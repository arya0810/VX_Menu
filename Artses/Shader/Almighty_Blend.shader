...
Shader "MG/Almighty_Blend"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Input i = s.SurfInput;
			half4 c = 0;
			float2 uvsampler_Turb_Noise = i.uv_texcoord * sampler_Turb_Noise_ST.xy + sampler_Turb_Noise_ST.zw;
...
/*ASEBEGIN
Version=18500
641;73;1103;908;2210.681;1161.316;1;True;False
...
ASEEND*/
//CHKSM=DA6D38CA6934DE2E6DABBD8C3D80E4AFC540924C